...
export async function getWeatherForecastDailyCharts(
  ...
  const response: WeatherForecastDailyCharts = {
    ...
    precipitations: dailyForecast.map((daily) => ({
      time: dayjs(daily.time).format("ddd"),
      rainAccumulationMin: daily.rainAccumulationMin ?? 0,
      rainAccumulationMax: daily.rainAccumulationMax ?? 0,
      rainAccumulationAvg: daily.rainAccumulationAvg ?? 0,
      rainAccumulationRange: [
        daily.rainAccumulationMin ?? 0,
        daily.rainAccumulationMax ?? 0,
      ],
      rainAccumulationSum: daily.rainAccumulationSum ?? 0,
      sleetAccumulationMin: daily.sleetAccumulationMin ?? 0,
      sleetAccumulationMax: daily.sleetAccumulationMax ?? 0,
      sleetAccumulationAvg: daily.sleetAccumulationAvg ?? 0,
      sleetAccumulationRange: [
        daily.sleetAccumulationMin ?? 0,
        daily.sleetAccumulationMax ?? 0,
      ],
      // sleetAccumulationSum: daily.sleetAccumulationSum ?? 0,
      snowAccumulationMin: daily.snowAccumulationMin ?? 0,
      snowAccumulationMax: daily.snowAccumulationMax ?? 0,
      snowAccumulationAvg: daily.snowAccumulationAvg ?? 0,
      snowAccumulationRange: [
        daily.snowAccumulationMin ?? 0,
        daily.snowAccumulationMax ?? 0,
      ],
      snowAccumulationSum: daily.snowAccumulationSum ?? 0,
      iceAccumulationMin: daily.iceAccumulationMin ?? 0,
      iceAccumulationMax: daily.iceAccumulationMax ?? 0,
      iceAccumulationAvg: daily.iceAccumulationAvg ?? 0,
      iceAccumulationRange: [
        daily.iceAccumulationMin ?? 0,
        daily.iceAccumulationMax ?? 0,
      ],
      iceAccumulationSum: daily.iceAccumulationSum ?? 0,
    })),
  };
